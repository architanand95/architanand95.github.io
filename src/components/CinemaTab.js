...
const Underrated_CinemaTab = () => {
  const moviesData = [
    ...
    },
    {
      ...
      description: "The story is about Joseph and Flavy Braganza, a deaf couple in Goa. They have a baby girl, Annie, who is able to speak and hear. A few years later they have another baby, a boy named Sam, who also speaks and hears. Annies life is divided into two worlds – one with her parents and the other of music, which she loves. Annie gets her musical inspirations from her grandmother, Maria Braganza .A few years later, after the tragic death of Sam, Annies life is shattered and music and singing fade away. When Annie grows up she gets in touch with music once again – with Raj whom she falls in love with. She starts singing again. When Annie gets pregnant, her father tells her to abort the baby because it will dishonor the family. Annie refuses to go against her church and religion. When Joseph learns this, he asks Annie to leave the house. Raj tries to convince Annies father that he is a nice guy, but Joseph dislikes him mainly because he is a Hindu who doesnt live in Goa, so Annie would have to live far away from him.Annie marries Raj and gives birth to a boy, whom they name Sam, after her brother. She, Raj, and Sam go to Josephs house to reconcile with him. Joseph accepts Annies boy and approves Raj as his son-in-law. Things are really beautiful until their life takes a drastic turn. Annie and Raj have a devastating accident; Annie is seriously injured and goes into a coma. Joseph, Flavy, and Raj try hard to revive her, even trying to stir her emotionally for the sake of Sam. The broken Raj, Josephs moving mute speech, and Flavys love and hope bring Annie back to consciousness.",
      image: "/movie2.jpeg",
    },
    {
      id: 3,
      title: "Manorama Six Feet Under",
      description: "The film opens with Satyaveer Singh Randhawa, a public works engineer, living a mundane life in the desolate town of Lakhot, Rajasthan. His wife Nimmi is dissatisfied with their financial situation, and Satyaveer, a failed novelist, feels resigned to his unremarkable life. One night, an affluent woman, Mrs. P. P. Rathore, approaches Satyaveer to hire him to procure evidence of her husbands affair. She pays him, and Satyaveer manages to get some photos for her. However, things take a mysterious turn when Satyaveer realizes the woman who hired him isnt who she claimed to be. He later encounters a woman named Manorama, who is running from pursuers. She asks him to remember her name and age before dying in what appears to be a suicide related to a canal project sponsored by Rathore.Satyaveer decides to investigate further and discovers that Manorama was connected to a local childrens home. He is attacked by thugs looking for information. Meanwhile, he befriends Manoramas roommate, Sheetal, who eventually stays with him for a while. Satyaveer attends an event with Rathore and follows him, discovering Rathores illegitimate daughter, Sameera.As Satyaveer digs deeper, he finds that Sameera and her doctor have been murdered. He also learns that Rathore is a pedophile who used the orphaned children from the home for his own purposes. Satyaveer confronts Rathore with evidence, including shocking photos, revealing Rathores crimes. He also reveals that Manorama and the doctor wanted to expose Rathores misdeeds.In the end, despite threats from Rathore, Satyaveer manages to escape and reunites with his family, realizing that sometimes the small fish can outsmart the big fish.",
      image: "/movie3.jpg",
    },
    {
      id:4,
      title: "Being Cyrus",
      description: "Cyrus Mistry, a wanderer, arrives at Dinshaw Sethnas house in Panchgani and becomes their sculpting apprentice. Dinshaw is an eccentric retired sculptor, and his wife Katy is having an affair with Farrokh, Dinshaws brother in Mumbai. Katy sends Cyrus to Mumbai to retrieve money from her ill-treated father-in-law, Fardoonjee, and her sister-in-law, Tina, whom Farrokh mistreats.Katy manipulates Cyrus into murdering Fardoonjee and Tina so she can be with Farrokh. However, Cyrus learns Farrokh plans to kill him afterward. He arrives when Tina is away, kills Fardoonjee, and then Farrokh. Cyrus informs Katy of her failed plan before disappearing.Katy and Dinshaw are arrested for the murders, as the police find no evidence of Cyrus existence. Tina, who was away during the murders, is released.Months later, Cyrus returns to Tinas apartment, revealing they are siblings. Tina orchestrated the murders to inherit the Sethna property. Cyrus, unwilling to continue the scheme, takes the stolen money and leaves Tina, who plans another scheme alone.",
      image: "/movie4.avif",
    },
    {
      id: 5,
      title: "Dhobi Ghat",
      description: "The film follows the lives of three characters in Mumbai: Arun, a reclusive artist; Shai, an American banker with a passion for photography; and Munna, a dhobi who dreams of becoming a Bollywood actor.Arun and Shai have a one-night stand after meeting at Aruns exhibition. However, Arun expresses disinterest in continuing the relationship, leading to an argument. Munna, a dhobi who delivers Aruns laundry, becomes friends with Shai and agrees to show her around Mumbai for her photography project.Arun discovers a container left by the previous tenant, Yasmin, containing video diaries. Through these tapes, he learns about Yasmins life and her struggles. Meanwhile, Shai begins to secretly photograph Arun from her fathers construction site opposite his apartment.Munna continues to struggle to break into the film industry, working as a dhobi by day and killing rats by night. Despite developing feelings for Shai, Munna is unable to express them due to their differing social statuses.As Arun watches Yasmins final tape, he realizes she may have committed suicide in the same apartment. This disturbs him, and he moves to a new place. Munnas life takes a tragic turn when his brother is killed, leading him to seek a new beginning in a different flat.The film ends with Arun completing a painting that includes elements of Yasmins life. Shai tries to find Munna, who initially tries to avoid her but then decides to give her Aruns new address, signifying a new connection between the characters.",
      image: "/movie5.jpg",
    },
  ...
  return (
    ...
    <div className={styles.cinemaTab}>
      <div className={styles.MovieMudda}>
          <p>As a movie buff with a deep appreciation for Indian cinema (and cinema in general!), Im always on the lookout for brilliant films that deserve a wider recognition.So I just thought  about sharing some of these underrated pieces of cinematic brilliance .If youre looking for something fresh and exciting, I highly recommend giving these movies a try. You wont be disappointed!</p>
      </div>
